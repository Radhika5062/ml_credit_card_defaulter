...
def save_object(file_path:str, obj:object) ->None:
    try:
        ...
        logging.info(f"Error occurred in the save_object method - {e}")
        raise e
...
def load_object(file_path:str) -> object:
    try:
        ...
        logging.info(f"Error occurred in the load_object method - {e}")
        raise e
...
def save_numpy_array_data(file_path:str, arr:np.array) ->None:
    try:
        ...
        logging.info(f"Error occurred in the save_numoy_array_data method - {e}")
        raise e
...
def load_numpy_array_data(file_path:str) -> np.array:
    try:
        ...
        logging.info(f"Error occured in the load_numpy_data method - {e}")
